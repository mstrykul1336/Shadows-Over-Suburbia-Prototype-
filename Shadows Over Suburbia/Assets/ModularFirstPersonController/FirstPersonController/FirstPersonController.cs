...
public class FirstPersonController : MonoBehaviourPun
{
    ...
    {
        // Disable AudioListener, movement scripts, etc. for remote players
        ...
        // Disable any other components that should not be used by remote players
    }
    ...
    public void DisablePlayerControls()
    {
        canMove = false;
        canLook = false;
        Cursor.lockState = CursorLockMode.None;  // Unlock the cursor so they can click UI
